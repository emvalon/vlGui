...
void vlGui_drawBlock(vlGui_window_t *win, int16_t x, int16_t y, int16_t width, int16_t height,
                     uint8_t color);
...
// void vlGui_drawDashedLine(vlGui_window_t *win, int16_t x1, int16_t y1, int16_t x2, int16_t y2,
//                           uint8_t dash_len, int16_t width, uint8_t color);
...
void vlGui_drawFilledCircle(vlGui_window_t *win, int16_t x0, int16_t y0, uint8_t rad,
                            vlGui_color color);
#endif