 ...
 */
void
vlGui_drawBlock(vlGui_window_t *win, int16_t x, int16_t y, int16_t width, int16_t height,
                uint8_t color)
{
...
void
vlGui_drawPoint(vlGui_window_t *win, int16_t x, int16_t y, uint8_t color)
{
...
static void
drawLineByPixel(vlGui_window_t *win, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint8_t color)
{
...
void
vlGui_drawLine(vlGui_window_t *win, int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t width,
               uint8_t color)
{
...
void
vlGui_drawBitmap(vlGui_window_t *win, int16_t x, int16_t y, int16_t width, int16_t height,
...
static void
vlGui_drawGlyph(vlGui_window_t *win, int16_t x, int16_t y, uint16_t glyph,
                const struct vlGui_font_t *font, vlGui_color color)
{
    uint8_t pos;
    uint8_t width;
    uint8_t *charAddr;
...
static void
vlGui_drawCircleSection(vlGui_window_t *win, int16_t x, int16_t y, int16_t x0, int16_t y0)
{
    /* upper right */
...
void
vlGui_drawCircle(vlGui_window_t *win, int16_t x0, int16_t y0, uint8_t rad)
{
    int16_t f;
    int16_t ddF_x;
    int16_t ddF_y;
...
static void
vlGui_drawFilledCircleSection(vlGui_window_t *win, int16_t x, int16_t y, int16_t x0, int16_t y0,
                              vlGui_color color)
{
    /* upper right */
...
void
vlGui_drawFilledCircle(vlGui_window_t *win, int16_t x0, int16_t y0, uint8_t rad, vlGui_color color)
{
    int16_t f;
    int16_t ddF_x;
    int16_t ddF_y;
